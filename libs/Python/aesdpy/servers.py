...
def get(api_url):
    """Get information about a AESD server.

    Args:
        api_url (string): The base url to query

    Returns:
        json: The AESD server information
    ...
    Example:
        ...
        .. code-block:: python
            ...
            import aesdpy
            aesdpy.servers.get('http://1lv11lamb01.nrel.gov:8091/')

        .. code-block:: javascript
            :caption: **aesdpy.servers.get response**
    ...
    **API Info**:
        ...
        .. http:get:: /
            ...
            :>resjson string version: the AESD API version number
...
def issue_command(api_url, body={}):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            aesdpy.servers.issue_command('http://1lv11lamb01.nrel.gov:8091/', body)
