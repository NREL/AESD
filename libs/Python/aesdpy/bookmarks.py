...
def list(api_url, model_id, query={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.list success 1

            import aesdpy
            aesdpy.bookmarks.list('http://1lv11lamb01.nrel.gov:8090', 'XXp')
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.list success 2

            import aesdpy
            aesdpy.bookmarks.list('http://1lv11lamb01.nrel.gov:8090', 'f0', {'lPqy': '5.0250953446542095'})
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.list failure

            import aesdpy
            aesdpy.bookmarks.list('http://1lv11lamb01.nrel.gov:8090', 'f0', {'lPqy': ''})
...
def get(api_url, model_id, bookmark_id):
    ...
    Example:
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.get success

            import aesdpy
            aesdpy.bookmarks.get('http://1lv11lamb01.nrel.gov:8090', 'f0', '68xQVjByK')
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.get failure 1

            import aesdpy
            aesdpy.bookmarks.get('http://1lv11lamb01.nrel.gov:8090', 'f0', 'abcd')
...
def add(api_url, model_id, body={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.add success
            ...
            aesdpy.bookmarks.add('http://1lv11lamb01.nrel.gov:8090', 'XXp', bookmark)
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.add failure 1
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.add failure 2
            ...
            aesdpy.bookmarks.add('http://1lv11lamb01.nrel.gov:8090', 'f0', bookmark)
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.add failure 3
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.add failure 4
...
def remove(api_url, model_id, bookmark_id):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.remove success

            import aesdpy
            aesdpy.bookmarks.remove('http://1lv11lamb01.nrel.gov:8090', 'f0', 'eUIbEM8')
        ...
        .. code-block:: python
            :caption: aesdpy.bookmarks.remove failure
