...
def get(api_url, model_id):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            import aesdpy
            aesdpy.models.get('http://1lv11lamb01.nrel.gov:8091', 'RSF2v0')
...
def list(api_url):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            import aesdpy
            aesdpy.models.list('http://1lv11lamb01.nrel.gov:8091/')
...
def issue_command(api_url, model_id, body={}):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            aesdpy.models.issue_command('http://1lv11lamb01.nrel.gov:8091/', 'RSF2v0', command)
