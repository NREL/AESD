...
def list(api_url, model_id, query={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.filters.list success 1

            import aesdpy
            aesdpy.filters.list('http://1lv11lamb01.nrel.gov:8090', 'f0')
        ...
        .. code-block:: python
            :caption: aesdpy.filters.list success 2

            import aesdpy
            aesdpy.filters.list('http://1lv11lamb01.nrel.gov:8090', 'f0', {'g': '"CENj"'})
        ...
        .. code-block:: python
            :caption: aesdpy.filters.list failure 1
        ...
        .. code-block:: python
            :caption: aesdpy.filters.list failure 2

            import aesdpy
            aesdpy.filters.list('http://1lv11lamb01.nrel.gov:8090', 'f0', {'g': ''})
...
def get(api_url, model_id, filter_id):
    ...
    Example:
        ...
        .. code-block:: python
            :caption: aesdpy.filters.get success

            import aesdpy
            aesdpy.filters.get('http://1lv11lamb01.nrel.gov:8090', 'f0', '4Gc8vhetIddL0zV8aSB')
        ...
        .. code-block:: python
            :caption: aesdpy.filters.get failure 1

            import aesdpy
            aesdpy.filters.get('http://1lv11lamb01.nrel.gov:8090', 'f0', 'abcd')
...
def add(api_url, model_id, body={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.filters.add success
            ...
            aesdpy.filters.add('http://1lv11lamb01.nrel.gov:8090', 'f0', filter)
        ...
        .. code-block:: python
            :caption: aesdpy.filters.add failure 1
        ...
        .. code-block:: python
            :caption: aesdpy.filters.add failure 2
...
def remove(api_url, model_id, filter_id):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: aesdpy.filters.remove success

            import aesdpy
            aesdpy.filters.remove('http://1lv11lamb01.nrel.gov:8090', 'f0', 'eUIbEM8')
        ...
        .. code-block:: python
            :caption: aesdpy.filters.remove failure
