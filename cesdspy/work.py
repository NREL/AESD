...
def list(api_url, model_id, query={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: cesdspy.work.list success 1

            import cesdspy
            cesdspy.work.list('http://1lv11lamb01.nrel.gov:8090', 'XXp')
        ...
        .. code-block:: python
            :caption: cesdspy.work.list success 2

            import cesdspy
            cesdspy.work.list('http://1lv11lamb01.nrel.gov:8090', 'f0', {'status': 'failed'})
...
def get(api_url, model_id, work_id):
    ...
    Example:
        ...
        .. code-block:: python
            :caption: cesdspy.work.get success

            import cesdspy
            cesdspy.work.get('http://1lv11lamb01.nrel.gov:8090', 'f0', 'X7Rsg')
        ...
        .. code-block:: python
            :caption: cesdspy.work.get failure 1

            import cesdspy
            cesdspy.work.get('http://1lv11lamb01.nrel.gov:8090', 'f0', 'abcd')
...
def issue(api_url, model_id, body={}):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: cesdspy.work.issue success
            ...
            cesdspy.work.issue('http://1lv11lamb01.nrel.gov:8090', 'XXp', work)
...
def cancel(api_url, model_id, work_id):
    ...
    Examples:
        ...
        .. code-block:: python
            :caption: cesdspy.work.remove success

            import cesdspy
            cesdspy.work.cancel('http://1lv11lamb01.nrel.gov:8090', 'f0', 'abc')
        ...
        .. code-block:: python
            :caption: cesdspy.work.cancel failure
